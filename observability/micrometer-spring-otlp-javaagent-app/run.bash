...
export OTEL_EXPORTER_OTLP_ENDPOINT=http://otel-collector.docker:4317
export OTEL_RESOURCE_ATTRIBUTES="service.namespace=com.mageddo,service.id=1231,service.version=1.0.0-alpha"
export OTEL_TRACES_SAMPLER="always_on"

java -javaagent:./tmp/otel-agent.jar -jar build/libs/micrometer-spring-otlp-javaagent-app.jar
