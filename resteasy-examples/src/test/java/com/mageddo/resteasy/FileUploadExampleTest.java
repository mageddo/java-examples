...
public class FileUploadExampleTest {
  ...
  public static class Proxy {
    ...
    public Response put(MultipartFormDataInput input) throws IOException {
      ...
      assertEquals("28d5bd1edef7e7f230bbf1b162bb1036", md5Hex(input.getFormDataPart("image",
          InputStream.class, null)));
      return Response.ok(IOUtils.toString(getClass().getResourceAsStream("/image-creation-res" +
          ".json"))).build();
    }
