...
4. executar, sem skips ou redução de escopo, o comando de build/testes do projeto.

Todos os testes, compilações e verificações estáticas aplicáveis devem passar.
