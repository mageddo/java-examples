    ...
    NetworkInterface
      ...
      .forEach(it -> {
        ...
        try {
          ...
          System.out.printf(
            "name=%s, isUp=%b, virtual=%b, loopback=%b, mac=%s, interfaceAddresses=%s, inetAddresses=%s%n",
            it.getName(), it.isUp(), it.isVirtual(), it.isLoopback(), hardwareIp, interfaceAddresses, inetAddresses
          );
